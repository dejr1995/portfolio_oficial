  ...
  return (
    ...
    >
      <div className="flex flex-col tracking-wide gap-2 relative">
        ...
        <h2 className="text-7xl font-bold text-neutral-700 mt-6 lg:-mt-6">{t("title2")}</h2>
        ...
        <div className="flex flex-col gap-6 mt-6 items-start">
          ...
          <a href="https://github.com/dejr1995"><span className="text-gray-900 font-semibold">GitHub</span></a>
          <a
          ...
          <a href="https://www.linkedin.com/in/diego-jara-devernlei"><span className="text-blue-die-link font-semibold">LinkedIn</span></a>
          </div>
          ...
          <a href="https://www.facebook.com/diego.jara.944"><span className="text-blue-die-fb font-semibold">Facebook</span></a>
          <a
          ...
          <a href="https://www.instagram.com/diego.jrxcx"><span className="text-pink-die-ig font-semibold">Instagram</span></a>
